...
from schnet_integration.legacy.Units import Units
...
class GeometrySchnetDB:
    ...
    def __init__(self, db_name, path=None):
        ...
        if path is None:
            ...
            # TODO: Better path management, this is only provisorisch
            self.path = os.path.join(path, DB_NAME_TEMPLATE.format(self.db_name))
    ...
    def _load_existing_db(self):
        ...
        print("constructor", self.__str__())
    ...
    def _load_units_from_db(self):
        ...
        """
        properties = [
            MolProperty(prop) for prop in self.schnet_db.available_properties]
